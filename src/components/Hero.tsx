export default function Hero() {
  return (
    <>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center pt-36 sm:pt-28">
          ...
          <p className="text-white/60 text-xl sm:text-2xl md:text-3xl font-display italic max-w-3xl mx-auto mb-4 leading-relaxed">
            Preserving the sacred tradition of<br />
      ...
      {/* Stats Section - solid background, no fade */}
      <section className="relative bg-burgundy-deep">
        {/* Top gold line */}
          ...
          <div className="grid grid-cols-3 gap-6 sm:gap-12 max-w-2xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="text-temple-gold-pale font-display text-3xl sm:text-4xl font-bold mb-1">
                  {stat.number}
                </div>
                <div className="text-white/70 text-[11px] sm:text-xs font-body tracking-wide">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        {/* Fade AFTER stats into cream */}
        <div className="h-24 bg-gradient-to-b from-burgundy-deep to-cream" />
      </section>
    </>
  );
}
